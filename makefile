...
VERSION   ?= 1.6.5#$(call get_gh_version,influxdata/kapacitor)
...
# runtime flags
MOUNTFLAGS := \
	# -v $(CURDIR)/data:/var/lib/kapacitor \
...
get_config: ## get default config from github
	curl \
		-o $(CURDIR)/root/defaults/kapacitor.conf \
		-SL https://raw.githubusercontent.com/influxdata/kapacitor/v$(VERSION)/etc/kapacitor/kapacitor.conf \
		# https://raw.githubusercontent.com/influxdata/kapacitor/master/etc/kapacitor/kapacitor.conf
